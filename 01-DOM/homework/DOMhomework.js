...
// span.innerHTML = 'Aplicación creada por Andres'

// Seleccionamos el SPAN con ID "createdby"
...
function buildToDo(todo, index) {
  ...
  let span = document.createElement('toDoText')
    const toDoText = document.getElementById('toDoText');
    toDoText.innerHTML = todo.description;

    toDoText.document.createElement(index)
...
function displayToDos() {
  ...
  result = buildToDo(toDoItems).forEach(element => {
    toDoContainer.push(element)
});
  }
...
// Tu código acá:
let boton = getElementById("addButton")
